...
public class  profile_activity extends AppCompatActivity{
    ...
    public void find(View view) {
        ...
        }else
        {
            ...
            buffer += "Enroll No." +" " +cursor.getString(2)+ "\n";
            buffer += "Contact No."+" " + cursor.getString(3)+ "\n";
            buffer += "Roll No."+" "+ cursor.getInt(4)+ "\n";
            buffer += " " + attendance+ "\n";
            ...
            {
                Toast.makeText(getBaseContext(),"No Attendancse Info Available",Toast.LENGTH_LONG).show();
            }else
            {
                cursorx.moveToFirst();

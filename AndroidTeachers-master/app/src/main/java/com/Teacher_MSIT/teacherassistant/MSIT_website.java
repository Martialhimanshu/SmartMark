...
/**
 * Created by Kashyap on 4/16/2017.
 */
...
public class MSIT_website extends AppCompatActivity {

    private String postUrl = "http://www.msit.in/";
        ...
        webView.setWebViewClient(new WebViewClient() {
            ...
            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                ...
                if (Utils.isSameDomain(postUrl, url)) {
                    Intent intent = new Intent(MSIT_website.this, MSIT_website.class);
    ...
    private void openInAppBrowser(String url) {
        Intent intent = new Intent(MSIT_website.this, MSIIT_browser.class);
    ...
    private void initCollapsingToolbar() {
        ...
        appBarLayout.addOnOffsetChangedListener(new AppBarLayout.OnOffsetChangedListener() {
            ...
            public void onOffsetChanged(AppBarLayout appBarLayout, int verticalOffset) {
                ...
                if (scrollRange + verticalOffset == 0) {
                    collapsingToolbar.setTitle("MSIT");
                    isShow = true;
                } else if (isShow) {
                    collapsingToolbar.setTitle(" ");
                    isShow = false;
        ...
        Glide.with(getApplicationContext()).load("http://educrib.com/logos/a2a35c8975044e2fd0ee79ccea3535damist_logo.jpg")
                .thumbnail(0.5f)
                .crossFade()

...
public class MoodleBrowser  extends AppCompatActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            setContentView(R.layout.moodle_browser);
        ...
        private void initWebView() {
            webView.setWebChromeClient(new com.Teacher_MSIT.teacherassistant.MoodleBrowser.MyWebChromeClient(this));
